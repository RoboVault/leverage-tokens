...
abstract contract ILend {
    ...
    function compTokenAddress() public view virtual returns (address);
    function compLpAddress() public view virtual returns (address);
    ...
    */
     ...
     * Misc
     */
    function claimComp() internal virtual;
}
